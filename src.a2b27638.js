...
},{}],"src/can.js":[function(require,module,exports) {
"use strict";
...
exports.default = Can;
},{"/src/constants":"src/constants.js"}],"src/cup.js":[function(require,module,exports) {
"use strict";
...
exports.default = Cup;
},{}],"src/retryBtn.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(RetryButton, [{
    key: "draw",
    value: function draw(context) {
      var retryBtn = document.getElementById("img-retry");
...
var InputHandler =
/*#__PURE__*/
_createClass(function InputHandler(game) {
...
},{"/src/constants":"src/constants.js"}],"src/game.js":[function(require,module,exports) {
"use strict";
...
var _can = _interopRequireDefault(require("/src/can"));

var _cup = _interopRequireDefault(require("/src/cup"));

var _retryBtn = _interopRequireDefault(require("/src/retryBtn"));
...
function () {
  function Game(gameWidth, gameHeight) {
    ...
    this.retryButton = new _retryBtn.default(this);
    this.can = new _can.default(this);
    this.cups = [new _cup.default(this, {
      x: this.gameWidth / 3.5
    }), new _cup.default(this, {
      x: this.gameWidth / 1.9
    }), new _cup.default(this, {
      x: this.gameWidth / 1.3
    })];
  ...
  _createClass(Game, [{
    ...
    value: function start() {
      this.can.reset();
      this.gameObjects = [this.can, this.retryButton].concat(_toConsumableArray(this.cups));
...
},{"/src/can":"src/can.js","/src/cup":"src/cup.js","/src/retryBtn":"src/retryBtn.js","/src/input":"src/input.js","/src/constants":"src/constants.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
requestAnimationFrame(gameLoop);
},{"/src/game":"src/game.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
